    ...
    experience: {
      ...
      items: {
        1: {
          ...
          endDate: "JUN 2026",
          highlights: [
            "Developed from scratch the new Dólar MEP buy/sell experience for Santander’s mobile banking app, partnering with UX/UI and owning Frontend, BFF, production rollout, and monitoring.",
            "Built the External Accounts feature for the mobile Dólar MEP flow, owning Frontend and BFF development and enabling purchases through linked accounts from other banks and fintechs. Supports thousands of daily operations.",
            "Owned the end-to-end development of the new Market & Tenders experiences for Home Banking, from Figma to production; enabled clients to explore market assets with pricing and daily performance and execute tender transactions, replacing legacy monolithic flows with scalable microfrontends and microservices.",
            "Developed the Voluntary Corporate Events feature across Frontend and BFF, enabling clients to exchange assets from their holdings for available investment alternatives.",
            "Resolved production incidents across investment products, coordinating with business teams and using Kibana and OpenShift to analyze logs, identify root causes, and validate fixes.",
          ],
        },
        2: {
          position: "Software Engineer",
          ...
          endDate: "SEP 2023",
          highlights: [
            "Refactored the complete Dólar MEP buy/sell transactional UI for Home Banking Web, replacing legacy frontend code with scalable React components and delivering a fully responsive experience across screen sizes.",
            "Implemented accessibility improvements across Dólar MEP transactional flows on Web and Mobile, as well as the mobile investment holdings and market experience, applying WCAG best practices and validating accessibility with NVDA.",
            "Led a full UI/UX refactor of the mobile investment holdings and market experience, enabling clients to review their holdings, explore market assets, and execute asset buy/sell operations, while resolving functional issues and monitoring production incidents.",
          ],
        },
        3: {
          ...
          endDate: "OCT 2022",
          highlights: [
            "Refactored login and authentication interfaces using React, improving component structure, form validation, and maintainability across client-facing web projects.",
            "Developed and refined responsive UI and landing page components, applying reusable CSS patterns and React best practices within real-world consulting projects.",
          ],
        },
      },
    },
    ...
    experience: {
      ...
      items: {
        1: {
          ...
          endDate: "JUN 2026",
          highlights: [
            "Desarrollé desde cero la nueva experiencia transaccional de compra y venta de Dólar MEP para la app móvil de Santander, trabajando con UX/UI y siendo responsable del Frontend, BFF, puesta en producción y monitoreo.",
            "Implementé la funcionalidad External Accounts para el flujo mobile de Dólar MEP, desarrollando Frontend y BFF y permitiendo realizar compras mediante cuentas vinculadas de otros bancos y fintechs. Soporta miles de operaciones diarias.",
            "Fui responsable del desarrollo end-to-end de las nuevas experiencias de Mercados y Licitaciones para Home Banking, desde Figma hasta producción; permitiendo consultar activos del mercado con sus cotizaciones y variación diaria y operar licitaciones, reemplazando funcionalidades legacy del monolito por microfrontends y microservicios escalables.",
            "Desarrollé la funcionalidad de Eventos Corporativos Voluntarios en Frontend y BFF, permitiendo a los clientes canjear activos de su tenencia por alternativas de inversión disponibles.",
            "Resolví incidencias productivas en funcionalidades de inversiones, coordinando con equipos de negocio y utilizando Kibana y OpenShift para analizar logs, identificar causas raíz y validar soluciones.",
          ],
        },
        2: {
          position: "Software Engineer",
          ...
          endDate: "SEP 2023",
          highlights: [
            "Refactoricé por completo la interfaz de compra y venta de Dólar MEP para Home Banking Web, reemplazando código legacy por componentes escalables en React y desarrollando una experiencia completamente responsive.",
            "Implementé mejoras de accesibilidad en los flujos transaccionales de Dólar MEP para Web y app móvil, así como en la experiencia mobile de tenencias y mercado, aplicando buenas prácticas WCAG y validando la accesibilidad mediante NVDA.",
            "Realicé un refactor completo de UI/UX de la experiencia mobile de tenencias y mercado, permitiendo a los clientes consultar sus tenencias, explorar activos del mercado y realizar operaciones de compra y venta, además de resolver errores funcionales y realizar seguimiento de incidencias productivas.",
          ],
        },
        3: {
          position: "Frontend Developer Intern",
          ...
          endDate: "OCT 2022",
          highlights: [
            "Refactoricé interfaces de login y autenticación utilizando React, mejorando la estructura de componentes, validaciones y mantenibilidad en proyectos web para clientes.",
            "Desarrollé y optimicé interfaces responsive y componentes para landing pages, aplicando patrones reutilizables de CSS y buenas prácticas de React en proyectos reales de consultoría.",
          ],
        },
      },
    },
